...
public:
    ...
    bool transformCloud(){
        ...
        try{listener.lookupTransform("camera_init","aft_mapped", ros::Time(0), transform); }
        ...
        laserCloudIn->header.frame_id = "aft_mapped";
        ...
        pcl_ros::transformPointCloud("camera_init", *laserCloudIn, laserCloudTemp, listener);
    ...
    void updateLaserScan(){
        ...
        try{listener.lookupTransform("aft_mapped","camera_init", ros::Time(0), transform);}
        ...
        pcl::PointCloud<PointType> laserCloudTemp;
        pcl_ros::transformPointCloud("aft_mapped", *laserCloudObstacles, laserCloudTemp, listener);
    ...
    void pointcloud2laserscanInitialization(){
        ...
        laserScan.header.frame_id = "aft_mapped"; // assume laser has the same frame as the robot
